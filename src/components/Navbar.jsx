  ...
  return (
    <div className="dps-wrapper">
      ...
      <div className="text-container">
        <h2><span className="welcome-blue">Welcome to</span> <br />
        <span className="school-red">Delhi Public School</span></h2>
        <p className="subtitle">A Center of Excellence – Inspiring Every Student to Achieve More</p>
        <p className="description">
          At Delhi Public School, we are committed to a holistic educational experience
          that goes beyond textbooks—nurturing young minds to become lifelong learners,
 ...
 <section className="info-grid-wrapper">
      <div className="info-grid">
        ...
        <div className="info-card tall-card">
          ...
          <h3>Achievements</h3>
         <p>
    Delhi Public School has consistently achieved academic excellence, with students securing top
    ranks in national and international examinations such as IIT-JEE, NEET, Olympiads, and SAT.
    Numerous alumni have earned scholarships and admissions into Ivy League universities, top UK
    institutions, and renowned Indian colleges. DPS students have also excelled in MUNs, debates,
    science fairs, and innovation challenges, bringing home accolades from countries like the USA,
    Japan, Australia, Singapore, and Germany.
  </p>
        </div>
        ...
        <div className="info-card tall-card">
          ...
          <p>
    DPS believes in the all-round development of its students through a wide spectrum of
    co-curricular activities. These include performing arts like music, dance, and drama;
    fine arts such as painting and sculpture; and literary clubs for debate, elocution,
    and creative writing. Students also engage in clubs like Robotics, Astronomy, Eco Club,
    and Coding. Regular events like Cultural Day, Science Exhibition, and Heritage Week foster
    teamwork, confidence, and leadership skills that complement their academic journey.
  </p>
        </div>
        ...
        <div className="info-card">
          ...
          <h3>Sports</h3>
          <p>
            Wide variety of sports like Football, Basketball, Athletics & more to
            foster physical fitness, discipline, and team spirit.
          </p>
        </div>
        ...
        <div className="info-card">
          ...
          <h3>Affiliated With Which Board</h3>
          <p>
            Delhi Public School is affiliated with the Central Board of Secondary
            Education (CBSE), India's premier educational board.
          </p>
        </div> */}
      </div>
    </section>
      ...
      <footer className="footer-section">
        <div className="footer-container">
          <div className="footer-column">
            <h3>Symbiosis <br />International School</h3>
            <p>
              Symbiosis International School,<br />
              Ishanya Campus, off Symbiosis Road,<br />
              Viman Nagar, Pune, Maharashtra - 411014
            </p>
            <p>📞 +91 020 26522100</p>
            <p>✉️ sis@symbiosis.ac.in</p>
          </div>
...
<div className="bottom-footer">
  <p>
    © 2024 Symbiosis International School. Developed with <span className="heart">❤️</span> by OG Advertising.
  </p>
