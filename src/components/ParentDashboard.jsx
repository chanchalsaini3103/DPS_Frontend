...
const ParentDashboard = () => {
  ...
  const handleSaveChild = () => {
    ...
    const requestBody = {
      ...
      parent: { parentId: localStorage.getItem("parentId") }, // use fresh session parentId
    };
    ...
    fetch(`${import.meta.env.VITE_API_BASE_URL}/api/register`, {
      ...
      .catch(() => Swal.fire("❌ Error", "Failed to add child", "error"));
  };
  ...
  return (
    <div className="container mt-4">
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <button className="btn btn-danger" style={{ position: "absolute", right: "30px" }} onClick={handleLogout}>
          Logout
        </button>
      </div>
          ...
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-success" onClick={handleSaveChild}>Save & Mark as Paid</button>
              </div>
            </div>
          </div>
        </div>
